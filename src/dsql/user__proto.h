...
ISC_STATUS API_ROUTINE gds__dsql_finish(isc_handle *);
ISC_STATUS API_ROUTINE gds__execute(ISC_STATUS*, isc_handle *, const SCHAR*, SQLDA*);
ISC_STATUS API_ROUTINE gds__execute_immediate(ISC_STATUS*, isc_handle *, isc_handle *,
											 SSHORT*, const SCHAR*);
...
ISC_STATUS API_ROUTINE gds__open(ISC_STATUS*, isc_handle *, SCHAR*, SQLDA*);
ISC_STATUS API_ROUTINE gds__prepare(ISC_STATUS*, isc_handle *, isc_handle *, const SCHAR*,
...
ISC_STATUS API_ROUTINE isc_dsql_finish(isc_handle *);
...
ISC_STATUS API_ROUTINE isc_embed_dsql_exec_immed(ISC_STATUS*, isc_handle *, isc_handle *,
	USHORT, const SCHAR*, USHORT, XSQLDA*);
ISC_STATUS API_ROUTINE isc_embed_dsql_exec_immed2(ISC_STATUS*, isc_handle *, isc_handle *,
	USHORT, const SCHAR*, USHORT, XSQLDA*, XSQLDA*);
ISC_STATUS API_ROUTINE isc_embed_dsql_execute(ISC_STATUS*, isc_handle *,
	const SCHAR*, USHORT, XSQLDA*);
ISC_STATUS API_ROUTINE isc_embed_dsql_execute2(ISC_STATUS*, isc_handle *,
	const SCHAR*, USHORT, XSQLDA*, XSQLDA*);
ISC_STATUS API_ROUTINE isc_embed_dsql_execute_immed(ISC_STATUS*, isc_handle *,
	isc_handle *, USHORT, const SCHAR*, USHORT, XSQLDA*);
...
ISC_STATUS API_ROUTINE isc_embed_dsql_open(ISC_STATUS*, isc_handle *, SCHAR*, USHORT, XSQLDA*);
ISC_STATUS API_ROUTINE isc_embed_dsql_open2(ISC_STATUS*, isc_handle *, const SCHAR*, USHORT, XSQLDA*, XSQLDA*);
ISC_STATUS API_ROUTINE isc_embed_dsql_prepare(ISC_STATUS*, isc_handle *, isc_handle *,
	const SCHAR*, USHORT, const SCHAR*, USHORT, XSQLDA*);
ISC_STATUS API_ROUTINE isc_embed_dsql_release(ISC_STATUS*, const SCHAR*);
ISC_STATUS API_ROUTINE isc_execute(ISC_STATUS*, isc_handle *, const SCHAR*, SQLDA*);
ISC_STATUS API_ROUTINE isc_execute_immediate(ISC_STATUS*, isc_handle *, isc_handle *,
	SSHORT*, const SCHAR*);
...
ISC_STATUS API_ROUTINE isc_open(ISC_STATUS*, isc_handle *, const SCHAR*, SQLDA*);
ISC_STATUS API_ROUTINE isc_prepare(ISC_STATUS*, isc_handle *, isc_handle *, SCHAR*, SSHORT*,
	const SCHAR*, SQLDA*);
