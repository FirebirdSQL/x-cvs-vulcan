...
#define FREE_PATTERN 0xDDDDDDDD
#define ALLOC_PATTERN 0xCCCCCCCC
...
firebird::MemoryPool* getDefaultMemoryPool() {
	if (!firebird::processMemoryPool) 
		firebird::processMemoryPool = MemoryPool::createPool();
...
#endif // SYSTEM_NEW
/***
void firebird::MemoryPool::globalFree(void* block)
		{
	if (block)
		{
