...
extern GPRE_PRC SQL_procedure(GPRE_REQ, const TEXT *, const TEXT *, const TEXT *, BOOLEAN);
extern GPRE_REL SQL_relation(GPRE_REQ, const TEXT *, const TEXT *, const TEXT *, BOOLEAN);
extern void SQL_resolve_identifier(const TEXT *, TEXT *);
extern GPRE_REL SQL_view(GPRE_REQ, const TEXT *, const TEXT *, const TEXT *, BOOLEAN);
