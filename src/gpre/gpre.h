...
typedef struct dbb {
	...
	isc_handle dbb_handle;			/* OUR db handle */
	isc_handle dbb_transaction;		/* default transaction */
	...
	isc_handle dbb_field_request;
	isc_handle dbb_flds_request;
	isc_handle dbb_relation_request;
	isc_handle dbb_procedure_request;
	isc_handle dbb_udf_request;
	isc_handle dbb_trigger_request;
	isc_handle dbb_proc_prms_request;
	isc_handle dbb_proc_prm_fld_request;
	isc_handle dbb_index_request;
	isc_handle dbb_type_request;
	isc_handle dbb_array_request;
	isc_handle dbb_dimension_request;
	isc_handle dbb_domain_request;
	isc_handle dbb_generator_request;
	isc_handle dbb_view_request;
	isc_handle dbb_primary_key_request;
...
inline int RSE_LEN(size_t nItems)
	{
	return (int) (offsetof(rse, rse_context) + nItems * sizeof(int *));
	}
