...
static BOOLEAN scompare(const char *, const char *);
static BOOLEAN scompare2(const char *, const char *);
...
SYM HSH_lookup(const TEXT * string)
{
	SYM symbol;
...
SYM HSH_lookup2(const TEXT * string)
{
	SYM symbol;
...
static BOOLEAN scompare( const char * string1, const char * string2)
{
...
static BOOLEAN scompare2( const char * string1, const char * string2)
{
	SCHAR c1, c2;
