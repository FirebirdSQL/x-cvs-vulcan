...
#ifdef SUPERSERVER
#define GET_THREAD_DATA			((TGBL) THD_get_specific(THDD_TYPE_TGBL))
#define SET_THREAD_DATA		 THD_put_specific ((THDD) tdgbl, THDD_TYPE_TGBL); \
				tdgbl->tgbl_thd_data.thdd_type = THDD_TYPE_TGBL
#define RESTORE_THREAD_DATA	 THD_restore_specific(THDD_TYPE_TGBL);
#else
extern tgbl* gdgbl;
