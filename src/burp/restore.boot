...
#line 680 "restore.epp"
	...
	if (count)
	{
		...
		{
		isc_commit_transaction (isc_status, (FB_API_HANDLE*) &gds_trans);;
#line 701 "restore.epp"
		// existing ON_ERROR continues past error, beck
		/*ON_ERROR*/
		if (isc_status [1])
		   {
#line 703 "restore.epp"
			BURP_print (174);
...
#line 789 "restore.epp"
		db_version = DB_VERSION_DDL5;
	/*END_FOR;*/
	   }
	   };
#line 791 "restore.epp"
	/*ON_ERROR*/
	if (isc_status [1])
	   {
...
#line 798 "restore.epp"
		db_version = DB_VERSION_DDL8;
	/*END_FOR;*/
	   }
	   };
#line 800 "restore.epp"
	/*ON_ERROR*/
	if (isc_status [1])
	   {
...
#line 2130 "restore.epp"
	/*ON_ERROR*/
	if (isc_status [1])
	   {
#line 2131 "restore.epp"
		general_on_error ();
	/*END_ERROR;*/
	   }
	}
#line 2133 "restore.epp"
...
#line 2165 "restore.epp"
				GET_TEXT(/*X.RDB$CONSTRAINT_NAME*/
					 isc_503.isc_505);
#line 2166 "restore.epp"
				break;
...
#line 2180 "restore.epp"
	/*ON_ERROR*/
	if (isc_status [1])
	   {
#line 2181 "restore.epp"
		general_on_error ();
	/*END_ERROR;*/
	   }
	}
#line 2183 "restore.epp"
...
#line 2248 "restore.epp"
				/*X.RDB$SYSTEM_FLAG*/
				isc_487.isc_494 = (USHORT) get_numeric();
#line 2249 "restore.epp"
				break;
...
#line 2268 "restore.epp"
	/*ON_ERROR*/
	if (isc_status [1])
	   {
#line 2269 "restore.epp"
		general_on_error ();
	/*END_ERROR;*/
	   }
	}
#line 2271 "restore.epp"
...
#line 2289 "restore.epp"
	...
	if (tdgbl->gbl_sw_incremental)
	{
		...
		{
		isc_commit_transaction (isc_status, (FB_API_HANDLE*) &gds_trans);;
#line 2619 "restore.epp"
		// existing ON_ERROR continues past error, beck 
		/*ON_ERROR*/
		if (isc_status [1])
		   {
#line 2621 "restore.epp"
...
#line 2636 "restore.epp"
							/*MODIFY IDX USING*/
							{ /*IDX.RDB$INDEX_INACTIVE*/
 isc_479.isc_481 = TRUE;
#line 2637 "restore.epp"
							BURP_print(240, index_name);
							/* msg 240 Index \"%s\" failed to activate because: */
							if ( error_code == isc_no_dup )
							{
...
#line 2661 "restore.epp"
						...
						if (isc_status [1])
						   {
#line 2662 "restore.epp"
							continue;
						/*END_ERROR*/
						   }
						}
#line 2664 "restore.epp"
						break;
					default:
						...
						{
						isc_rollback_transaction (isc_status, (FB_API_HANDLE*) &gds_trans);;
#line 2670 "restore.epp"
						/*ON_ERROR*/
						if (isc_status [1])
						   {
#line 2671 "restore.epp"
							general_on_error ();
						/*END_ERROR;*/
						   }
						}
#line 2673 "restore.epp"
						break;
				} // end of switch 
			} // end of while 
		/*END_ERROR;*/
...
#line 2709 "restore.epp"
		/*X.RDB$DESCRIPTION.NULL*/
		isc_470.isc_475 = TRUE;
#line 2710 "restore.epp"
		/*X.RDB$MESSAGE.NULL*/
		isc_470.isc_473 = TRUE;
#line 2711 "restore.epp"
		skip_init(&scan_next_attr);
		while (skip_scan(&scan_next_attr), get_attribute(&attribute, tdgbl) != att_end)
		{
			switch (attribute)
...
#line 2725 "restore.epp"
				/*X.RDB$DESCRIPTION.NULL*/
				isc_470.isc_475 = FALSE;
#line 2726 "restore.epp"
				break;
...
#line 2745 "restore.epp"
	...
	if (isc_status [1])
	   {
#line 2746 "restore.epp"
		general_on_error ();
	/*END_ERROR;*/
	   }
	}
#line 2748 "restore.epp"
...
#line 2867 "restore.epp"
				/*X.RDB$SYSTEM_FLAG.NULL*/
				isc_435.isc_456 = FALSE;
#line 2868 "restore.epp"
				break;
...
#line 2873 "restore.epp"
			...
			case att_base_field:
				GET_TEXT(/*X.RDB$BASE_FIELD*/
					 isc_435.isc_444);
#line 2882 "restore.epp"
				/*X.RDB$BASE_FIELD.NULL*/
				isc_435.isc_465 = FALSE;
#line 2883 "restore.epp"
				break;
...
#line 2923 "restore.epp"
				/*X.RDB$UPDATE_FLAG*/
				isc_435.isc_454 = (USHORT) get_numeric();
#line 2924 "restore.epp"
				break;
...
#line 2952 "restore.epp"
				/*X.RDB$COLLATION_ID*/
				isc_435.isc_448 = field->fld_collation_id;
#line 2953 "restore.epp"
				break;
...
#line 2963 "restore.epp"
	/*ON_ERROR*/
	if (isc_status [1])
	   {
#line 2964 "restore.epp"
		general_on_error ();
	/*END_ERROR;*/
	   }
	}
#line 2966 "restore.epp"
...
#line 3017 "restore.epp"
	/*ON_ERROR*/
	if (isc_status [1])
	   {
#line 3018 "restore.epp"
		general_on_error ();
	/*END_ERROR;*/
	   }
	}
#line 3020 "restore.epp"
 ...
 **************************************/
	...
	if (tdgbl->handles_get_files_req_handle1)
	   {
#line 3044 "restore.epp"
		/*X.RDB$FILE_FLAGS*/
		isc_421.isc_427 = 0;
#line 3045 "restore.epp"
		skip_init(&scan_next_attr);
		while (skip_scan(&scan_next_attr), get_attribute(&attribute, tdgbl) != att_end)
		{
			switch (attribute)
			...
			case att_file_filename:
				GET_TEXT(/*X.RDB$FILE_NAME*/
					 isc_421.isc_426);
#line 3052 "restore.epp"
				BURP_verbose (116,
					/*X.RDB$FILE_NAME*/
					isc_421.isc_426);
#line 3054 "restore.epp"
...
#line 3075 "restore.epp"
				if (tdgbl->gbl_sw_kill && /*X.RDB$SHADOW_NUMBER*/
							  isc_421.isc_424)
#line 3076 "restore.epp"
					/*X.RDB$FILE_FLAGS*/
					isc_421.isc_427 |= FILE_inactive;
#line 3077 "restore.epp"
				break;
...
#line 3086 "restore.epp"
	/*ON_ERROR*/
	if (isc_status [1])
	   {
#line 3087 "restore.epp"
		general_on_error ();
	/*END_ERROR;*/
	   }
	}
#line 3089 "restore.epp"
...
#line 3112 "restore.epp"
		/*X.RDB$DESCRIPTION.NULL*/
		isc_412.isc_419 = TRUE;
#line 3113 "restore.epp"
		skip_init(&scan_next_attr);
		while (skip_scan(&scan_next_attr), get_attribute(&attribute, tdgbl) != att_end)
		{
			switch (attribute)
			...
			case att_filter_name:
				GET_TEXT(/*X.RDB$FUNCTION_NAME*/
					 isc_412.isc_414);
#line 3120 "restore.epp"
				BURP_verbose (117, /*X.RDB$FUNCTION_NAME*/
						   isc_412.isc_414);
#line 3121 "restore.epp"
...
#line 3126 "restore.epp"
				get_misc_blob (&/*X.RDB$DESCRIPTION*/
						isc_412.isc_415, 1, false);
#line 3127 "restore.epp"
				break;
...
#line 3157 "restore.epp"
	/*ON_ERROR*/
	if (isc_status [1])
	   {
#line 3158 "restore.epp"
		general_on_error ();
	/*END_ERROR;*/
	   }
	}
#line 3160 "restore.epp"
...
#line 3234 "restore.epp"
	/*ON_ERROR*/
	if (isc_status [1])
	   {
#line 3235 "restore.epp"
		general_on_error ();
	/*END_ERROR;*/
	   }
	}
...
#line 3272 "restore.epp"
			...
			while (skip_scan(&scan_next_attr), get_attribute(&attribute, tdgbl) != att_end)
			{
				...
				case att_functionarg_name:
					l = GET_TEXT(/*X.RDB$FUNCTION_NAME*/
						     isc_389.isc_390);
#line 3280 "restore.epp"
					MISC_terminate (/*X.RDB$FUNCTION_NAME*/
							isc_389.isc_390, temp, l, sizeof(temp));
#line 3281 "restore.epp"
...
#line 3327 "restore.epp"
		/*ON_ERROR*/
		if (isc_status [1])
		   {
#line 3328 "restore.epp"
			general_on_error ();
		/*END_ERROR;*/
		   }
		}
#line 3330 "restore.epp"
	}
	else
	{
		...
		if (tdgbl->handles_get_function_arg_req_handle1)
		   {
#line 3336 "restore.epp"
		/*X.RDB$FIELD_SUB_TYPE.NULL*/
		isc_377.isc_386 = TRUE;
#line 3337 "restore.epp"
		/*X.RDB$CHARACTER_SET_ID.NULL*/
		isc_377.isc_384 = TRUE;
#line 3338 "restore.epp"
			...
			while (skip_scan(&scan_next_attr), get_attribute(&attribute, tdgbl) != att_end)
			{
				...
				case att_functionarg_name:
					l = GET_TEXT(/*X.RDB$FUNCTION_NAME*/
						     isc_377.isc_378);
#line 3346 "restore.epp"
					MISC_terminate (/*X.RDB$FUNCTION_NAME*/
							isc_377.isc_378, temp, l, sizeof(temp));
#line 3347 "restore.epp"
					BURP_verbose (119, temp);
					// msg 119 restoring argument for function %s 
					break;
...
#line 3388 "restore.epp"
		/*ON_ERROR*/
		if (isc_status [1])
		   {
#line 3389 "restore.epp"
			general_on_error ();
		/*END_ERROR;*/
		   }
		}
#line 3391 "restore.epp"
	}
}
...
#line 3511 "restore.epp"
				...
				case att_field_query_name:
					GET_TEXT(/*X.RDB$QUERY_NAME*/
						 isc_322.isc_332);
#line 3517 "restore.epp"
					/*X.RDB$QUERY_NAME.NULL*/
					isc_322.isc_368 = FALSE;
#line 3518 "restore.epp"
					break;
...
#line 3550 "restore.epp"
					if (/*X.RDB$SEGMENT_LENGTH*/
					    isc_322.isc_374)
#line 3551 "restore.epp"
						/*X.RDB$SEGMENT_LENGTH.NULL*/
						isc_322.isc_347 = FALSE;
#line 3552 "restore.epp"
					break;
...
#line 3729 "restore.epp"
			{
				l = gds_cvt_blr_dtype[/*X.RDB$FIELD_TYPE*/
						      isc_322.isc_337];
#line 3731 "restore.epp"
				if (l = type_lengths[l])
					/*X.RDB$FIELD_LENGTH*/
					isc_322.isc_336 = l;
...
#line 3739 "restore.epp"
		/*ON_ERROR*/
		if (isc_status [1])
		   {
#line 3740 "restore.epp"
			general_on_error ();
		/*END_ERROR;*/
		   }
		}
#line 3742 "restore.epp"
...
#line 3779 "restore.epp"
			...
			while (skip_scan(&scan_next_attr), get_attribute(&attribute, tdgbl) != att_end)
			{
				...
				case att_field_name:
					l = GET_TEXT(/*X.RDB$FIELD_NAME*/
						     isc_269.isc_270);
#line 3786 "restore.epp"
					MISC_terminate (/*X.RDB$FIELD_NAME*/
							isc_269.isc_270, temp, l, sizeof(temp));
#line 3787 "restore.epp"
					BURP_verbose (121, temp);
					// msg 121  restoring global field %s 
					break;
				...
				case att_field_query_name:
					GET_TEXT(/*X.RDB$QUERY_NAME*/
						 isc_269.isc_279);
#line 3793 "restore.epp"
					/*X.RDB$QUERY_NAME.NULL*/
					isc_269.isc_313 = FALSE;
#line 3794 "restore.epp"
					break;
...
#line 3826 "restore.epp"
					if (/*X.RDB$SEGMENT_LENGTH*/
					    isc_269.isc_319)
#line 3827 "restore.epp"
						/*X.RDB$SEGMENT_LENGTH.NULL*/
						isc_269.isc_292 = FALSE;
#line 3828 "restore.epp"
					break;
...
#line 3864 "restore.epp"
							get_blr_blob (&/*X.RDB$VALIDATION_BLR*/
								       isc_269.isc_275, false);
#line 3865 "restore.epp"
						}
					}
					break;
...
#line 3888 "restore.epp"
							get_misc_blob (&/*X.RDB$VALIDATION_SOURCE*/
									isc_269.isc_274, 0, false);
#line 3889 "restore.epp"
						}
					}
					break;
				...
				case att_field_validation_source2:
					...
					else
					{
						...
						else
						{
							/*X.RDB$VALIDATION_SOURCE.NULL*/
							isc_269.isc_306 = FALSE;
#line 3912 "restore.epp"
							get_source_blob (&/*X.RDB$VALIDATION_SOURCE*/
									  isc_269.isc_274, false);
#line 3913 "restore.epp"
						}
					}
					break;
...
#line 3919 "restore.epp"
					get_blr_blob (&/*X.RDB$MISSING_VALUE*/
						       isc_269.isc_277, false);
#line 3920 "restore.epp"
					break;
...
#line 4000 "restore.epp"
			{
				l = gds_cvt_blr_dtype[/*X.RDB$FIELD_TYPE*/
						      isc_269.isc_284];
#line 4002 "restore.epp"
				if (l = type_lengths[l])
					/*X.RDB$FIELD_LENGTH*/
					isc_269.isc_283 = l;
...
#line 4010 "restore.epp"
		/*ON_ERROR*/
		if (isc_status [1])
		   {
#line 4011 "restore.epp"
			general_on_error ();
		/*END_ERROR;*/
		   }
		}
#line 4013 "restore.epp"
...
#line 4051 "restore.epp"
		strcpy (/*X.RDB$RELATION_NAME*/
			isc_252.isc_258, relation->rel_name);
#line 4052 "restore.epp"
		/*X.RDB$UNIQUE_FLAG*/
		isc_252.isc_267 = 0;
#line 4053 "restore.epp"
		if (!tdgbl->gbl_sw_deactivate_indexes)
...
#line 4083 "restore.epp"
				...
				if (tdgbl->gbl_sw_verbose)
				{
					if (/*X.RDB$INDEX_INACTIVE*/
					    isc_252.isc_266 == FALSE)
#line 4088 "restore.epp"
						/*X.RDB$INDEX_INACTIVE*/
						isc_252.isc_266 = DEFERRED_ACTIVE;
#line 4089 "restore.epp"
				}
				else
				{
					if (/*X.RDB$INDEX_INACTIVE*/
...
#line 4134 "restore.epp"
			...
			case att_index_foreign_key:
				...
				if (/*X.RDB$INDEX_INACTIVE*/
				    isc_252.isc_266 == FALSE)
#line 4140 "restore.epp"
					/*X.RDB$INDEX_INACTIVE*/
					isc_252.isc_266 = DEFERRED_ACTIVE;
#line 4141 "restore.epp"
				if (tdgbl->gbl_sw_deactivate_indexes)
					/*X.RDB$INDEX_INACTIVE*/
					isc_252.isc_266 = TRUE;
#line 4143 "restore.epp"
				/*X.RDB$FOREIGN_KEY.NULL*/
...
#line 4159 "restore.epp"
			count++;
		/*END_FOR;*/
		   }
		   };
#line 4161 "restore.epp"
		/*ON_ERROR*/
		if (isc_status [1])
		   {
#line 4162 "restore.epp"
			general_on_error ();
		/*END_ERROR;*/
		   }
		}
#line 4164 "restore.epp"
...
#line 4354 "restore.epp"
				/*X.RDB$DESCRIPTION.NULL*/
				isc_217.isc_229 = FALSE;
#line 4355 "restore.epp"
				break;
...
#line 4405 "restore.epp"
	/*ON_ERROR*/
	if (isc_status [1])
	   {
#line 4406 "restore.epp"
		general_on_error ();
	/*END_ERROR;*/
	   }
	}
...
#line 4488 "restore.epp"
	/*ON_ERROR*/
	if (isc_status [1])
	   {
#line 4489 "restore.epp"
		general_on_error ();
	/*END_ERROR;*/
	   }
	}
#line 4491 "restore.epp"
...
#line 4526 "restore.epp"
					GET_TEXT(/*X.RDB$CONSTRAINT_NAME*/
						 isc_196.isc_199);
#line 4527 "restore.epp"
					break;
...
#line 4556 "restore.epp"
	/*ON_ERROR*/
	if (isc_status [1])
	   {
#line 4557 "restore.epp"
		general_on_error ();
	/*END_ERROR;*/
	   }
	}
#line 4559 "restore.epp"
	...
	while (get_record(&record, tdgbl) != rec_data)
	{
		...
		case rec_relation_end:
			if (tdgbl->gbl_sw_incremental)
			{
				...
				{
				isc_commit_transaction (isc_status, (FB_API_HANDLE*) &gds_trans);;
#line 4755 "restore.epp"
				// existing ON_ERROR continues past error, beck 
				/*ON_ERROR*/
				if (isc_status [1])
				   {
#line 4757 "restore.epp"
...
#line 4761 "restore.epp"
					...
					if (isc_status [1])
					   {
#line 4762 "restore.epp"
						general_on_error ();
					/*END_ERROR;*/
					   }
					}
#line 4764 "restore.epp"
				/*END_ERROR;*/
				   }
				}
...
#line 4768 "restore.epp"
	...
	{
	isc_commit_transaction (isc_status, (FB_API_HANDLE*) &gds_trans);;
#line 4799 "restore.epp"
	/*ON_ERROR*/
	if (isc_status [1])
	   {
#line 4800 "restore.epp"
		general_on_error ();
	/*END_ERROR;*/
	   }
	}
#line 4802 "restore.epp"
...
#line 4844 "restore.epp"
					GET_TEXT(/*X.RDB$CONSTRAINT_NAME*/
						 isc_161.isc_164);
#line 4845 "restore.epp"
					break;
...
#line 4879 "restore.epp"
	/*ON_ERROR*/
	if (isc_status [1])
	   {
#line 4880 "restore.epp"
		general_on_error ();
	/*END_ERROR;*/
	   }
	}
#line 4882 "restore.epp"
 ...
 **************************************/
	...
	if (tdgbl->handles_get_sql_roles_req_handle1)
	   {
#line 4995 "restore.epp"

		/*X.RDB$ROLE_NAME.NULL*/
		isc_155.isc_159 = TRUE;
#line 4997 "restore.epp"
		/*X.RDB$OWNER_NAME.NULL*/
...
#line 5018 "restore.epp"
				GET_TEXT(/*X.RDB$OWNER_NAME*/
					 isc_155.isc_156);
#line 5019 "restore.epp"
				break;
...
#line 5032 "restore.epp"
	/*ON_ERROR*/
	if (isc_status [1])
	   {
#line 5033 "restore.epp"
		general_on_error ();
	/*END_ERROR;*/
	   }
	}
...
#line 5142 "restore.epp"
	/*ON_ERROR*/
	if (isc_status [1])
	   {
#line 5143 "restore.epp"
		general_on_error ();
	/*END_ERROR;*/
	   }
	}
...
#line 5270 "restore.epp"
		/*X.RDB$DESCRIPTION.NULL*/
		isc_136.isc_147 = TRUE;
#line 5271 "restore.epp"
		/*X.RDB$TRIGGER_BLR.NULL*/
		isc_136.isc_146 = TRUE;
#line 5272 "restore.epp"
...
#line 5349 "restore.epp"
	...
	if (tdgbl->gbl_sw_incremental)
	{
		...
		{
		isc_commit_transaction (isc_status, (FB_API_HANDLE*) &gds_trans);;
#line 5353 "restore.epp"
		// existing ON_ERROR continues past error, beck 
		/*ON_ERROR*/
		if (isc_status [1])
		   {
#line 5355 "restore.epp"
			BURP_print (94, name);
			...
			{
			isc_rollback_transaction (isc_status, (FB_API_HANDLE*) &gds_trans);;
#line 5359 "restore.epp"
			/*ON_ERROR*/
			if (isc_status [1])
			   {
#line 5360 "restore.epp"
				general_on_error ();
			/*END_ERROR;*/
			   }
			}
...
#line 5395 "restore.epp"
		/*X.RDB$DESCRIPTION.NULL*/
		isc_119.isc_134 = TRUE;
#line 5396 "restore.epp"
		/*X.RDB$TRIGGER_BLR.NULL*/
		isc_119.isc_133 = TRUE;
#line 5397 "restore.epp"
		/*X.RDB$TRIGGER_SOURCE.NULL*/
...
#line 5407 "restore.epp"
				break;

			case att_trig_flags:
				/*X.RDB$FLAGS*/
				isc_119.isc_129 = (USHORT) get_numeric();
#line 5411 "restore.epp"
				/*X.RDB$FLAGS.NULL*/
				isc_119.isc_128 = FALSE;
#line 5412 "restore.epp"
				break;

			case att_trig_blr:
				/*X.RDB$TRIGGER_BLR.NULL*/
				isc_119.isc_133 = FALSE;
#line 5416 "restore.epp"
				get_blr_blob (&/*X.RDB$TRIGGER_BLR*/
					       isc_119.isc_123, true);
#line 5417 "restore.epp"
				break;

			case att_trig_source:
				/*X.RDB$TRIGGER_SOURCE.NULL*/
				isc_119.isc_132 = FALSE;
#line 5421 "restore.epp"
				get_misc_blob (&/*X.RDB$TRIGGER_SOURCE*/
						isc_119.isc_122, 1, true);
#line 5422 "restore.epp"
				break;

			case att_trig_source2:
				/*X.RDB$TRIGGER_SOURCE.NULL*/
				isc_119.isc_132 = FALSE;
#line 5426 "restore.epp"
				get_source_blob (&/*X.RDB$TRIGGER_SOURCE*/
						  isc_119.isc_122, true);
#line 5427 "restore.epp"
				break;

			case att_trig_name:
				GET_TEXT(/*X.RDB$TRIGGER_NAME*/
					 isc_119.isc_121);
#line 5431 "restore.epp"
				strcpy (name, /*X.RDB$TRIGGER_NAME*/
					      isc_119.isc_121);
#line 5432 "restore.epp"
				BURP_verbose (126, /*X.RDB$TRIGGER_NAME*/
						   isc_119.isc_121);
#line 5433 "restore.epp"
				// msg 126 restoring trigger %s 
				break;
...
#line 5470 "restore.epp"
	/*ON_ERROR*/
	if (isc_status [1])
	   {
#line 5471 "restore.epp"
		general_on_error ();
	/*END_ERROR;*/
	   }
	}
#line 5473 "restore.epp"
	...
	if (tdgbl->gbl_sw_incremental)
	{
		...
		{
		isc_commit_transaction (isc_status, (FB_API_HANDLE*) &gds_trans);;
#line 5477 "restore.epp"
		// existing ON_ERROR continues past error, beck 
		/*ON_ERROR*/
		if (isc_status [1])
		   {
#line 5479 "restore.epp"
			BURP_print (94, name);
			// msg 94 trigger %s is invalid 
			BURP_print_status (tdgbl->status_vector);
			/*ROLLBACK;*/
			{
			isc_rollback_transaction (isc_status, (FB_API_HANDLE*) &gds_trans);;
#line 5483 "restore.epp"
			/*ON_ERROR*/
			if (isc_status [1])
			   {
#line 5484 "restore.epp"
				general_on_error ();
			/*END_ERROR;*/
			   }
			}
...
#line 5528 "restore.epp"
				flag = true;
			/*END_FOR;*/
			   }
			   };
#line 5530 "restore.epp"
			/*ON_ERROR*/
			if (isc_status [1])
			   {
...
#line 5568 "restore.epp"
	...
	if (tdgbl->gbl_sw_incremental)
	{
		...
		{
		isc_commit_transaction (isc_status, (FB_API_HANDLE*) &gds_trans);;
#line 5572 "restore.epp"
		// existing ON_ERROR continues past error, beck 
		/*ON_ERROR*/
		if (isc_status [1])
		   {
#line 5574 "restore.epp"
			BURP_print (94, name);
			// msg 94 trigger %s is invalid 
			BURP_print_status (tdgbl->status_vector);
			/*ROLLBACK;*/
			{
			isc_rollback_transaction (isc_status, (FB_API_HANDLE*) &gds_trans);;
#line 5578 "restore.epp"
			/*ON_ERROR*/
			if (isc_status [1])
			   {
#line 5579 "restore.epp"
				general_on_error ();
			/*END_ERROR;*/
			   }
			}
...
#line 5611 "restore.epp"
		/*X.RDB$DESCRIPTION.NULL*/
		isc_100.isc_107 = TRUE;
#line 5612 "restore.epp"
		/*X.RDB$SYSTEM_FLAG.NULL*/
		isc_100.isc_105 = TRUE;
#line 5613 "restore.epp"
		skip_init(&scan_next_attr);
		while (skip_scan(&scan_next_attr), get_attribute(&attribute, tdgbl) != att_end)
		{
			switch (attribute)
...
#line 5653 "restore.epp"
		BURP_verbose (128, temp, /*X.RDB$FIELD_NAME*/
					 isc_100.isc_101);
#line 5654 "restore.epp"
...
#line 5689 "restore.epp"
	...
	if (exists)
	{
		...
		if (tdgbl->handles_get_user_privilege_req_handle1)
		   {
#line 5793 "restore.epp"

			/*X.RDB$FIELD_NAME.NULL*/
			isc_86.isc_97 = TRUE;
#line 5795 "restore.epp"
...
#line 5822 "restore.epp"
			...
			isc_86.isc_91 = FALSE;
#line 5834 "restore.epp"
			/*X.RDB$USER_TYPE*/
			isc_86.isc_92 = user_type;
#line 5835 "restore.epp"
...
#line 5859 "restore.epp"
		/*ON_ERROR*/
		if (isc_status [1])
		   {
#line 5860 "restore.epp"
			general_on_error ();
		/*END_ERROR;*/
		   }
		}
...
#line 5917 "restore.epp"
	/*ON_ERROR*/
	if (isc_status [1])
	   {
#line 5918 "restore.epp"
		general_on_error ();
	/*END_ERROR;*/
	   }
	}
...
#line 6356 "restore.epp"
					if (attribute == att_database_description2)
						get_source_blob (&/*X.RDB$DESCRIPTION*/
								  isc_72.isc_73, false);
#line 6358 "restore.epp"
					else
						get_misc_blob (&/*X.RDB$DESCRIPTION*/
								isc_72.isc_73, 1, false);
#line 6360 "restore.epp"
				/*END_MODIFY;*/
...
#line 6631 "restore.epp"

		/*MODIFY X*/
		{;
#line 6633 "restore.epp"
...
#line 6639 "restore.epp"

	/*END_FOR;*/
           isc_send (isc_status, (FB_API_HANDLE*) &req_handle2, (short) 3, (short) 2, &isc_54, (short) 0);
	   }
	   };
#line 6641 "restore.epp"

	/*ON_ERROR*/
	if (isc_status [1])
	   {
#line 6643 "restore.epp"
		MISC_release_request_silent(req_handle2);
		general_on_error ();
	/*END_ERROR;*/
	   }
	}
#line 6646 "restore.epp"
...
#line 6814 "restore.epp"
			...
			if (gfield->gfld_flags & GFLD_validation_source)
			{
				/*X.RDB$VALIDATION_SOURCE.NULL*/
				isc_30.isc_34 = FALSE;
#line 6823 "restore.epp"

				if (length = sizeof(ISC_QUAD))
				{
					UCHAR* p = (UCHAR *)&/*X.RDB$VALIDATION_SOURCE*/
							     isc_30.isc_31;
#line 6827 "restore.epp"
			...
			if (gfield->gfld_flags & GFLD_validation_source2)
			{
				/*X.RDB$VALIDATION_SOURCE.NULL*/
				isc_30.isc_34 = FALSE;
#line 6836 "restore.epp"

				if (length = sizeof(ISC_QUAD))
				{
					UCHAR* p = (UCHAR *)&/*X.RDB$VALIDATION_SOURCE*/
							     isc_30.isc_31;
#line 6840 "restore.epp"
