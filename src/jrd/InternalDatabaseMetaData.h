...
#ifndef _INTERNALDATABASEMETADATA_H_
#define _INTERNALDATABASEMETADATA_H_
...
class InternalDatabaseMetaData : public DatabaseMetaData  
{
public:
	virtual int objectVersion();
	InternalDatabaseMetaData(InternalConnection *connect);
	virtual ~InternalDatabaseMetaData();
