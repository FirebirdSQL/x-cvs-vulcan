 ...
 **************************************/
	...
	if (length && length < MAXPATHLEN) {
		...
		// case where temp is of the form "foo.fdb" and expanded_name is "c:\x\y".  
	...
	file_length = (USHORT) ShortToLongPathName(expanded_name, expanded_name2, MAXPATHLEN);
...
#pragma FB_COMPILER_MESSAGE("ISC_verify_database_access disabled")
