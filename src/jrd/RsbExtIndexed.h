...
#ifndef JRD_RSB_EXT_INDEXED_H
#define JRD_RSB_EXT_INDEXED_H

#include "RsbIndexed.h"

class RsbExtIndexed : public RsbIndexed
{
public:
	RsbExtIndexed(CompilerScratch *csb, int stream, Relation *relation, str *alias, jrd_nod *node);
	virtual ~RsbExtIndexed(void);
