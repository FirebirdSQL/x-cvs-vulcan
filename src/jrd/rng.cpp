...
#ifdef PC_ENGINE
static void delete_range(TDBB tdbb, RNG);
static void post_event(RNG);
static void post_event_ast(RNG);
static void stop_creating(TDBB tdbb, RNG);
#endif


#ifdef PC_ENGINE
void RNG_add_page(TDBB tdbb, ULONG page_number)
{
/**************************************
 *
...
#ifdef PC_ENGINE
void RNG_add_record(TDBB tdbb, RPB * rpb)
{
/**************************************
 *
...
#ifdef PC_ENGINE
JRD_NOD RNG_add_relation(TDBB tdbb, JRD_NOD node)
{
/**************************************
 *
...
#ifdef PC_ENGINE
void RNG_add_uncommitted_record(TDBB tdbb, RPB * rpb)
{
/**************************************
 *
...
#ifdef PC_ENGINE
DSC *RNG_begin(TDBB tdbb, JRD_NOD node, VLU impure)
{
/**************************************
 *
 *	R N G _ b e g i n
...
#ifdef PC_ENGINE
JRD_NOD RNG_delete(TDBB tdbb, JRD_NOD node)
{
/**************************************
 *
 *	R N G _ d e l e t e
...
#ifdef PC_ENGINE
JRD_NOD RNG_end(TDBB tdbb, JRD_NOD node)
{
/**************************************
 *
 *	R N G _ e n d
...
#ifdef PC_ENGINE
void RNG_release_locks(TDBB tdbb, RNG refresh_range)
{
/**************************************
 *
 ...
 **************************************/
	...
	if (refresh_ranges = request->req_refresh_ranges)
		for (range_number = 0; range_number < refresh_ranges->vec_count;
			...
			if (refresh_range =
				(RNG) refresh_ranges->vec_object[range_number]) {
				RNG_release_locks(tdbb, refresh_range);
				--dbb->dbb_refresh_ranges;
			}
}
#endif
...
#ifdef PC_ENGINE
void RNG_shutdown_attachment(TDBB tdbb, ATT attachment)
{
/**************************************
 *
 ...
 **************************************/
	...
	for (request = attachment->att_requests; request; request = request->req_request)
		{
		if (refresh_ranges = request->req_refresh_ranges)
			for (range_number = 0; range_number < refresh_ranges->vec_count; range_number++)
				{
				if (refresh_range = (RNG) refresh_ranges->vec_object[range_number])
					{
...
#ifdef PC_ENGINE
static void delete_range(TDBB tdbb, RNG refresh_range)
{
/**************************************
 *
...
#ifdef PC_ENGINE
static void stop_creating(TDBB tdbb, RNG refresh_range)
{
/**************************************
 *
