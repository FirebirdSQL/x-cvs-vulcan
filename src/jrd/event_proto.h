...
SLONG EVENT_create_session(ISC_STATUS*, Database *database);
void EVENT_delete_session(SLONG);
void EVENT_deliver();
struct evh* EVENT_init(ISC_STATUS*, Database *database, USHORT);
int EVENT_post(ISC_STATUS*, Database *database, USHORT, TEXT*, USHORT, TEXT*, USHORT);
