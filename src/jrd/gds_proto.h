...
SSHORT	API_ROUTINE gds__msg_format(void*  handle,
									...
									const TEXT* arg4,
									const TEXT* arg5);
SSHORT	API_ROUTINE gds__msg_lookup(void*, USHORT, USHORT, USHORT,TEXT*, USHORT*);
...
USHORT	API_ROUTINE gds__parse_bpb2(USHORT, const UCHAR*, SSHORT*, SSHORT*,
									  USHORT*, USHORT*);
long	API_ROUTINE gds__ftof(const SCHAR*, const USHORT length1, SCHAR*,
...
int		API_ROUTINE gds__temp_file(const TEXT*, TEXT*, TEXT* = NULL,
	BOOLEAN = FALSE);
