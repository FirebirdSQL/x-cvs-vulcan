...
#pragma FB_COMPILER_MESSAGE("This needs to reference the configuration file")
...
#define THPS_TIME (PrioritySwitchDelayValue)	// ms between rescheds
#define THPS_TICKS (DeadThreadsCollectionValue)	// sched loops before thread killing
