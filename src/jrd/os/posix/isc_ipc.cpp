 ...
 *
 **************************************/
#if 0 // Jim Starkey says this is not needed in Vulcan, hopefully he's
      // right, as this is not thread safe
...
/* The signal handler needs the process id */
	...
	Sync sync (&sig_mutex, "isc_signal2");
	sync.lock(Exclusive);
 ...
 **************************************/
	...
	Sync sync (&sig_mutex, "isc_signal_cancel");
	sync.lock(Exclusive);
	//THD_MUTEX_LOCK(&sig_mutex);
