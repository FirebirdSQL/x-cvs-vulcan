 ...
 **************************************/
	...
	if (number && dbb->dbb_pc_transactions.size())
 ...
 **************************************/
	...
	for (tip_cache_ptr = &dbb->dbb_tip_cache; *tip_cache_ptr; tip_cache_ptr = &(*tip_cache_ptr)->tpc_next)
 ...
 **************************************/
	...
	for (TPC tip_cache = dbb->dbb_tip_cache; tip_cache; tip_cache = tip_cache->tpc_next) 
		if (number < (SLONG)(tip_cache->tpc_base + trans_per_tip)) 
			{
 ...
 **************************************/
	...
	for (; tip_cache; tip_cache = tip_cache->tpc_next)
		...
		if (number < (SLONG) (tip_cache->tpc_base + dbb->dbb_pcontrol->pgc_tpt))
			...
			temp_lock->lck_owner_handle = LCK_get_owner_handle();
 ...
 **************************************/
	...
	SLONG trans_per_tip = dbb->dbb_pcontrol->pgc_tpt;
	SLONG first_trans = sequence * trans_per_tip;
 ...
 **************************************/
	...
	for (ULONG base = oldest - oldest % trans_per_tip; base <= top; base += trans_per_tip) 
		{
