...
USHORT		EVL_group(thread_db* tdbb, RecordSource*, jrd_nod*, USHORT);
USHORT		EVL_mb_contains(thread_db* tdbb, TextType, const UCHAR*, USHORT, const UCHAR*, USHORT);
USHORT		EVL_mb_like(thread_db* tdbb, TextType, const UCHAR*, SSHORT, const UCHAR*, SSHORT, USHORT);
...
USHORT		EVL_mb_sleuth_merge(thread_db* tdbb, TextType, const UCHAR*, USHORT, const UCHAR*,
								USHORT, UCHAR*, USHORT);
void		EVL_make_value(thread_db* tdbb, const dsc*, impure_value*);
USHORT		EVL_nc_contains(thread_db* tdbb, TextType, const UCHAR*, USHORT, const UCHAR*, USHORT);
USHORT		EVL_nc_like(thread_db* tdbb, TextType, const UCHAR*, SSHORT, const UCHAR*, SSHORT, USHORT);
...
USHORT		EVL_wc_contains(thread_db* tdbb, TextType, const USHORT*, USHORT, const USHORT*, USHORT);
USHORT		EVL_wc_like(thread_db* tdbb, TextType, const USHORT*, SSHORT, const USHORT*, SSHORT, USHORT);
