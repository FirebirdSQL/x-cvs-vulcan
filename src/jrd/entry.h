...
ENTRYPOINT( "gds_prepare_transaction",
		  ...
		  "_jrd8_prepare_transaction",
			 ...
			 (ISC_STATUS*, class Transaction**, USHORT, UCHAR*))
...
ENTRYPOINT( "gds_reconnect_transaction",
		  ...
		  "_jrd8_reconnect_transaction",
			 ...
			 (ISC_STATUS*, struct att**, class Transaction**, SSHORT, const UCHAR*))
...
ENTRYPOINT("gds_start_and_send",
			...
			IPI_start_and_send,
			(ISC_STATUS*, struct jrd_req**, class Transaction**, USHORT, USHORT,
			    SCHAR*, SSHORT))
...
ENTRYPOINT("gds_start_request",
			...
			"_jrd8_start_request",
			IPI_start_request,
			(ISC_STATUS*, struct jrd_req**, class Transaction**, SSHORT))
...
ENTRYPOINT( "gds_start_multiple",
   ...
   /****     REM_start_multiple    ***/ y_valve_no_entrypoint,
		  ...
		  "_jrd8_start_multiple",
			 IPI_start_multiple,
		   (ISC_STATUS *, class Transaction**, USHORT, struct teb *))
...
ENTRYPOINT("gds_start_transaction",
		   ...
		   (ISC_STATUS*, class Transaction**, SSHORT, ...))
...
ENTRYPOINT( "gds_transaction_info",
		  ...
		  "_jrd8_transaction_info",
		   ...
		   (ISC_STATUS*, class Transaction**, SSHORT, const SCHAR*, SSHORT, SCHAR*))
...
ENTRYPOINT("gds_ddl",
   ...
   /****     RDB_ddl    ***/ y_valve_no_entrypoint,
			...
			"_jrd8_ddl",
			IPI_ddl,
			(ISC_STATUS*, struct att**, class Transaction**,
				USHORT, const SCHAR*))
...
ENTRYPOINT("gds_open_blob2",
   ...
   /****     RDB_open_blob2    ***/ y_valve_no_entrypoint,
			...
			"_jrd8_open_blob2",
			IPI_open_blob2,
			(ISC_STATUS*, struct att**, class Transaction**, struct blb**,
...
ENTRYPOINT( "gds_get_slice",
   ...
   /****     RDB_get_slice    ***/ y_valve_no_entrypoint,
			...
			"_jrd8_get_slice",
			IPI_get_slice,
			(ISC_STATUS*, struct att**, class Transaction**, SLONG*, USHORT,
...
ENTRYPOINT( "isc_transact_request",
   ...
   /****    PSI5_transact_request    ***/ y_valve_no_entrypoint,
			...
			(ISC_STATUS*, struct att**, class Transaction**, USHORT, const SCHAR*,
...
ENTRYPOINT("isc_rollback_retaining", jrd8_rollback_retaining,
   ...
   /****    PSI5_rollback_retaining    ***/ y_valve_no_entrypoint,
			   ...
			   IPI_rollback_retaining, (ISC_STATUS *, class Transaction**))
