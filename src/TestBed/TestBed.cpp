...
BOOL CTestBedApp::InitInstance()
{
	...
	SetRegistryKey(_T("Vulcan Testbed"));
	...
	pDocTemplate = new CMultiDocTemplate(
		IDR_TESTBETYPE,
		RUNTIME_CLASS(CTestBedDoc),
		RUNTIME_CLASS(CChildFrame), // custom MDI child frame
		RUNTIME_CLASS(CTestBedView));
	...
	CString path = GetProfileString ("Recent File List", "File1", "");
