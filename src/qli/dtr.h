...
typedef struct dbb {
    ...
    isc_handle dbb_handle;		/* database handle */
    isc_handle dbb_transaction;	/* transaction handle */
    isc_handle dbb_proc_trans;	/* procedure transaction */
    isc_handle dbb_meta_trans;	/* metadata update transaction */
    isc_handle dbb_field_request;	/* "get fields" request handle */
    ...
    isc_handle dbb_lookup_blob;	/* Request to look up blob */
    isc_handle dbb_store_blob;	/* Request to store blob */
    isc_handle dbb_edit_blob;
    isc_handle dbb_edit_store;
    isc_handle dbb_scan_blobs;
    isc_handle dbb_delete_blob;
    USHORT	dbb_flags;
    ...
    isc_handle dbb_requests [96];	/* Misc meta-data requests */
