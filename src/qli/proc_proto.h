...
extern void	PRO_close (struct dbb *, isc_handle );
...
extern isc_handle PRO_fetch_procedure (struct dbb *, TEXT *);
extern int	PRO_get_line (isc_handle , TEXT *, USHORT);
extern void	PRO_invoke (struct dbb *, TEXT *);
extern isc_handle PRO_open_blob (struct dbb *, SLONG *);
...
extern isc_handle PRO_transaction (struct dbb *, int);
